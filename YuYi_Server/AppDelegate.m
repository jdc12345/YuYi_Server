...
@interface AppDelegate ()<JPUSHRegisterDelegate,RCIMReceiveMessageDelegate, RCIMUserInfoDataSource,UNUserNotificationCenterDelegate>
...
//    //r---------- 6.1 发送未读信息通知 ----------
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"MessageUnreadNum" object:nil userInfo:nil];
...
-(void)getUserInfoWithUserId:(NSString *)userId completion:(void (^)(RCUserInfo *))completion{
    ...
    [[HttpClient defaultClient] requestWithPath:getUserInfoUrl method:0 parameters:nil prepareExecute:nil success:^(NSURLSessionDataTask *task, id responseObject) {
        ...
        RCUserInfo *userModel_rc = [[RCUserInfo alloc]initWithUserId:userId name:modle.trueName portrait:[NSString stringWithFormat:@"%@%@",mPrefixUrl,responseObject[@"avatar"]]];
